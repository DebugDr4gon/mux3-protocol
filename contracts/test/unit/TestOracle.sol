...
contract TestOracle is Pricing, TestSuit {
    ...
    function test_muxPriceProvider() external {
        mpp.initialize(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266); // signer
        ...
        assertEq(timestamp, 12345678, "E02");
    }
}
